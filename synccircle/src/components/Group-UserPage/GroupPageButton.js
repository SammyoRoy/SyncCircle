...
function GroupPageButton() {
  ...
  return (
    <div className="Groups">
      <button className="GroupPageButton btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasGroup" aria-controls="offcanvasGroup">
        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox=" 0 23 22" fill="none" style={{ position: 'relative', top: '-5px' }}a>
